...
TIMES="10"
CHATID="7523456640"
KEY="7572139805:AAGIomVmYqxrSTxSYX_io8eKkdLU7u3Tems"
...
<b>         𝗙𝗔𝗡𝗡𝗧𝗨𝗡𝗘𝗟    </b>
<code>────────────────────</code>
<code>𝙲𝚕𝚒𝚎𝚗𝚝 : </code><code>$USRSC</code>
<code>𝙳𝚊𝚝𝚎   : </code><code>$TIME</code>
<code>𝚃𝚒𝚖𝚎   : </code><code>$TIMEZONE</code>
<code>𝙴𝚡𝚙 𝚂𝚌 : </code><code>$EXPSC</code>
<code>────────────────────</code>
<i>Automatic Notification from Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/"},{"text":"WA","url":"https://wa.me/"}]]}'
...
wget raw.githubusercontent.com/$nama/script-new/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
